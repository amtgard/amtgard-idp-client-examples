class OAuthClient {
    ...
    async handleCallback() {
        ...
        localStorage.removeItem('pkce_code_verifier'); // Typically keep until exchange complete, but standard flow exchange is immediate
    ...
    isLoggedIn() {
        ...
        // Simple expiry check (with buffer)
